...
//     }
//   }, [title, projectId, date, createTodo, setSelectedOption]);
...
//                 />
//                 <div>
//                   <button>{selectedOption.title}</button>
//                   {Object.values(projects)
//                     .filter((i) => i.id !== todayId)
//                     .map((i) => (
//                       <div key={i.id} onClick={onOptionClicked(i)}>
//                         {i.title}
//                       </div>
//                     ))}
//                 </div>
...
//             {title ? (
//               <AddTaskButton onClick={handleSubmitTask} type="button">
//                 Add task
//               </AddTaskButton>
//             ) : (
//               <AddTaskButton
...
// export default SubmitTodayForm;
